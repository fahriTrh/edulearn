    ...
    <div class="bg-white rounded-xl shadow-sm p-1 mb-6">
        <div class="flex gap-2">
            <button 
                ...
                class="flex-1 px-6 py-3 rounded-lg font-semibold transition-all {{ $activeTab === 'review' ? 'bg-gradient-to-r from-purple-600 to-purple-800 text-white' : 'text-gray-600 hover:bg-gray-100' }}"
            >
                📝 Review & Grading
            </button>
            <button 
                wire:click="switchTab('daftar')"
                class="flex-1 px-6 py-3 rounded-lg font-semibold transition-all {{ $activeTab === 'daftar' ? 'bg-gradient-to-r from-purple-600 to-purple-800 text-white' : 'text-gray-600 hover:bg-gray-100' }}"
            >
                📊 Daftar Nilai
            </button>
            <button 
                wire:click="switchTab('final')"
                class="flex-1 px-6 py-3 rounded-lg font-semibold transition-all {{ $activeTab === 'final' ? 'bg-gradient-to-r from-purple-600 to-purple-800 text-white' : 'text-gray-600 hover:bg-gray-100' }}"
            >
                🎓 Final Grade
            </button>
        </div>
